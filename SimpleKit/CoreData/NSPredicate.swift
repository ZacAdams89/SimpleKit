...
extension NSPredicate{
    ...
    class func predicateWithKey(_ key: String, value: AnyObject) -> NSPredicate{
        //TODO: Test this
        return NSPredicate(format: "%K == %@", [value])
    }
    
    class func predicateWithKeyValues(_ keyValuePairs: Dictionary<String, AnyObject>) -> NSPredicate{
